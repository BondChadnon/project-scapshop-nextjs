...
export default function Home() {
      ...
      try{
        if(username===""||password===""){
          Swal.fire({
            icon:'error',
            title:'error',
            text:'Username and Password are Require'
          })
          return
        }
        const payload = {
  ...
  return (
      <div className="flex flex-col items-center justify-center min-h-screen p-10 bg-gradient-to-br from-gray-800 to-gray-950">
        <div className="text-gray-400 text-4xl font-bold mb-10"> Bond Service </div>
        <div className="bg-gray-800 p-8 rounded-2xl shadow-xl w-full max-w-md">
          ...
          <form className="flex flex-col gap-2 mt-10 w-full" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="btn mt-2 text-xl">
