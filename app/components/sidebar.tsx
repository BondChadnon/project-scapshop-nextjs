...
export function SideBar() {
    const menuItems = [
        ...
        {title:'ทะเบียนวัสดุ อุปกรณ์',href:'/dashboard/devices',icon:'fa-solid fa-box'},
    ...
    return(
        <aside className="sidebar">
            <div className="sidebar-header">
                ...
                <h1 className="text-xl font-bold">Bond Service 2025</h1>
            </div>
            <nav className="sidebar-nav bg-gray-950 p-4 rounded-tl-2xl ml-4">
                <ul>
                    {menuItems.map((item)=>(
                        <li key={item.title} >
